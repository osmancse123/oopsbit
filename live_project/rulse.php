...
$select_about="SELECT * FROM rules_hostel_transport where `type`='".$_GET['page']."'";
...
<div class="col-md-9 col-xs-12 fontsize backgroundcol"  style="padding:0px ; margin:0px; margin-top:10px; padding-top:10px;" >
		...
		<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:5px;">
					...
					<span class="changetitle"  style="font-size:18px; color:black; font-family:'Times New Roman', Times, serif"><?php echo $fetch_about[1];?></span>
		</div>

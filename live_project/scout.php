<?php
	if($_GET["page"]== "Cub"){
	$select_about="SELECT * FROM scout where title='Cub'";
		}
		
		
			if($_GET["page"]== "scout"){
		$select_about="SELECT * FROM scout where title='Scout'";
		}
...
<div class="col-md-9 col-xs-12 fontsize backgroundcol"  style="padding:0px ; margin:0px; margin-top:10px; padding-top:10px;" >
		...
		<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:5px;">
					...
					<span class="changetitle" style="font-size:18px;  font-family:'Times New Roman', Times, serif"><?php
					
					if($_GET["page"]== "scout"){
						print "Scout Informaton";
					}else {
						print "Cub Information";
					}
					?></span>
		</div>

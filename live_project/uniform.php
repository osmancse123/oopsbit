...
$select_about="SELECT * FROM uniform";
...
<div class="col-md-9 col-xs-12 fontsize backgroundcol"  style="padding:0px ; margin:0px; margin-top:10px; padding-top:10px;" >
		...
		<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:5px;">
					...
					<span class="changetitle"  style="font-size:18px; color:black; font-family:'Times New Roman', Times, serif">Uniform Picture and Details</span>
		</div>
		...
		<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:5px;">
					...
					<table class="table table-bordered table-responsive">
								<tbody>
											<tr>
													<td><img src="other_img/Uniform.jpg" style="height:250px; width:307px;" /></td>
											</tr>

<?php
	...
	$select_history="SELECT * FROM history";
		$result=$db->select_query($select_history);
		if($result){
		$fetch_history=$result->fetch_array();}
...
<div class="col-md-9 col-xs-12 fontsize backgroundcol"  style="padding:0px ; margin:0px; margin-top:10px; padding-top:10px;" >
		...
		<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:5px;">
					...
					<span class="changetitle" style="font-size:18px; color:black; font-family:'Times New Roman', Times, serif"><?php //print 
		$string1=$fetch_history[1];
								...
								<tbody>
											...
											<tr>
													<td><p style="text-align:justify; font-family:'Times New Roman', Times, serif">
															<?php  
		$string=$fetch_history[2];
		
		$a=array("\r\n", "\n", "\r");
		$replace='<br />';
		$about=str_replace($a, $replace, $string);
		print "<span class='text-justify text-info' style='font-size:16px;color:#000000'>".$about."</span>";

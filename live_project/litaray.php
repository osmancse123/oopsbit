...
<div class="col-md-9 col-xs-12 fontsize backgroundcol"  style="padding:0px ; margin:0px; margin-top:10px; padding-top:10px;" >
				...
				padding:0px; float:left; clear:right; text-align:left;">
						<span id="noticetitle"  style="color:#000000; font-size:20px; font-family:'Times New Roman', Times, serif; font-weight:300;"><?php  echo $_GET["page"] ?></span>
				</div>
	...
	$sql="SELECT COUNT(id) FROM `literature_culture_education` where type='".$_GET["page"]."'";
	...
	$sql1= "SELECT * FROM `literature_culture_education` where type='".$_GET["page"]."'  ORDER BY id DESC $limit";
		...
		if($pagenum > 1 )
		{
			...
			for($i = $pagenum+1;$i <= $last; $i++){
				...
				if($pagenum != $last)
				{
					...
					$an=preg_replace('#[^a-z,A-Z,অ-ঔ,ক-ঁ,া,ি,ী,ু,ূ,ে,ৈ,ো,ৌ,০-৯,0-9]#','',$fetch->type);
					$sl++;
						?>
								 <tr>
									<td align="center"><?php echo $sl;?></td>
									<td><a class="changetitle" href="?page=litaryview&litid=<?php echo $fetch->id;?>" style="text-decoration:none; color:#000000; font-family:'Times New Roman', Times, serif" id="titlecolor"><?php echo $fetch->type;?></a></td>
									<td align="center"><?php echo $fetch->date;?></td>
									<td align="center"><img src="img/picture.jpg" style="height:20px;"/></td>
								</tr>
				...
				<div class="col-md-12 col-xs-12" style="padding:0px; margin:0px;">
							<span><?php echo $_GET["page"]?> Archive</span>

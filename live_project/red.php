<?php
		if($_GET["page"]== "red"){
		$select_about="SELECT * FROM red_crecent_info";
		}
		
		if($_GET["page"]== "sport"){
		$select_about="SELECT * FROM sports";
		}
		
		if($_GET["page"]== "library"){
		$select_about="SELECT * FROM library_information";
		}
		if($_GET["page"]== "Girls"){
		$select_about="SELECT * FROM girlsguride";
		}
...
<div class="col-md-9 col-xs-12 fontsize backgroundcol"  style="padding:0px ; margin:0px; margin-top:10px; padding-top:10px;" >
		...
		<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:5px;">
					...
					<span class="changetitle" style="font-size:18px;  font-family:'Times New Roman', Times, serif"><?php //print 
		$string1=$fetch_about[1];

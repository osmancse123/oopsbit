  <?php
	...
	$db = new database();
		...
		if(isset($_POST["ResultGenerate"])){
			 ...
			 $class = explode('and',$_POST["className"]);
			//print_r($class);
				$examType = explode('and',$_POST["examtype"]);
				//print_r($examType);
				
				$update_query = "UPDATE `result` SET `Year`='".date('Y')."' WHERE `classId`='$class[0]' AND `examId`='$examType[0]' AND session='".$_POST["Session"]."'";
			if(	$resulQuery = $db->update_query($update_query)){
  ...
  <body>
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" >
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                <span class="glyphicon glyphicon-arrow-right text-justify text-uppercase text-warning" style="font-weight: bold; padding-top: 15px; font-size: 18px;"><strong style="padding-left:5px">Result Publish  </strong></span><br/>
                ...
                <tr><td colspan="2" align="center"><input type="submit" name="ResultGenerate" value="Result Publish" class="btn btn-danger btn-md" style="width: 180px" ></input>
				</td></tr>
                </table>

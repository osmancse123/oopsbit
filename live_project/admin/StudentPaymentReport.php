...
<div class="tab-content table-bordered" style="margin-bottom:20px;">
  <div id="home" class="tab-pane fade in active print" style="margin-bottom:10px;">
					...
					<span class="text-success print" style="font-size:15px; padding-left:10px;"><strong>Select Date : </strong></span><br/>

						<input type="text" name="date" id="date" style="width: 300px; height:30px; margin-left:10px;" autocomplete="off" class="print"   /> 
						&nbsp;&nbsp;
						<input type="button" value="Show" name="Show" onClick="ShowReportDaily()" class="print">
  ...
  <div id="menu1" class="tab-pane fade print" style="margin-bottom:20px; margin-top:20px; text-align:center">
  
  		
			<span class="print"><strong style="font-size:15px;">From Date</strong></span>&nbsp; &nbsp;<input type="text" class="FristDAte print" name="FristDAte" id="example1"/>&nbsp; &nbsp;
								<span class="print"><strong style="font-size:15px;">&nbsp;&nbsp;  To Date </strong></span>&nbsp; &nbsp;<input type="text" name="sndDAte" id="example12" class="sndDAte print"/>&nbsp;&nbsp;						
								<input  type="button" onClick="return shwoMonthlyReport()" name="submit" id="submit" value="Submit" class="print" />
  ...
  <div id="menu2" class="tab-pane fade print" >
			   <span class="text-success print" style="font-size:15px; padding-left:10px;"><strong>Select Year : </strong></span><br/>
								     <input type="text" name="years" id="years" style="width: 300px; height:30px; margin-left:10px;" onKeyUp="return showYearlyCost()" class="print" />

								     <input  type="button" onClick="return showYearlyCost()" name="submit" id="submit" value="Submit" class="print" />

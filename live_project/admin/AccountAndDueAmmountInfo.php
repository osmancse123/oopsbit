  ...
  <div id="home" class="tab-pane fade in active" style="margin-bottom:10px;">
    			...
    			<tr>
    				...
    				<select style="height: 30px; width: 160px;" id="type">
    					...
    					<option value="techYear">Teacher According Year</option>
    				</select>
...
<?php
	...
	?>
						...
						<tr>
								...
								<div id="idlist" class="ui-autocomplete"  style="text-align:left"></div><button class="btn btn-info" type="button" onclick="showAccountINfor()">Report</button></div> 
								</td>
...
<script type="text/javascript">
	...
	function showAccountINforStr(){
					var typeT = $('#type1').val();
					var month = $('#month1').val();
					var Years = $('#year1').val();
					var teacherId = $('#struffID').val();
				
			if(teacherId !=""){
							$.ajax({
										url : "Report/struff_report.php",
										data : {Years:Years,teacherId:teacherId,typeT:typeT,month:month},
										type : "POST",
										success:function(data){

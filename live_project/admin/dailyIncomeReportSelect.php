...
<html lang="en">
  <head>
    ...
    <title>Daily Fee Collection Report(Class wise)</title>
...
function check_availability()
{
  ...
  <body>
  	<form name="teacherinfo" action="DailyIncomeReport.php" method="get"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" >

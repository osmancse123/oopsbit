  ...
  <body>
	...
	<tr>
				...
				<td class="info">
					...
					<input type="text" name="index" placeholder="index" autocomplete="off"  class="form-control" value="<?php echo $fetch[6];?>" >
			...
			<tr>
				...
				<td class="info">
					<div class="col-lg-12 has-warning">
						<input type="text" placeholder="Amount" autocomplete="off" class="form-control" name="amount" value="<?php echo $fetch[4];?>" />
						<span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
					</div>
				</td>
				<td class='info'><span class="text-danger text-justify"><strong></strong></span ></td>

...
ON `income_expense_title`.`id`= other_cost.`title` WHERE `income_expense_title`.`type`='Expense' ORDER BY other_cost.`id` DESC ";
		...
		$table="<table class='table table-responsive table-hover table-bordered' align='center'>"."<tr class='success'>"."<td >ID </td>"."<td>Date</td>"."<td >Title </td>"."<td >Description</td>"."<td >Amount</td>"."<td>Entry Date</td><td>Edit Or Delete</td>"."</tr>";
		if($result)
		{
...
<html lang="en">
  ...
  <body>
  	...
  	<table align="center" class="table table-responsive box" style="border:1px #CCCCCC solid; margin-top:30px; color: #000;">
  			<tr>
  				<td bgcolor="#f4f4f4" class="warning" colspan="4" bgcolor="#dddddd" align="center"><span style="font-size:22px; color:#333; display:block;">Expense Entry </span> </td>
  			</tr>

<?php
    ...
    global $chek_query;
	$prefix=date("y"."m"."d");
$fetch_query[0]=$db->withoutPrefix('bittiexam','bittiexam_id',"14".$prefix,'12');
    ...
    {   
        ...
        $expensions= array("jpeg","jpg","png","pdf","");         
                ...
                @$inserquery="INSERT INTO `bittiexam`(`bittiexam_id`,`date_time`,`xm_title`,`description`,`extension`) VALUES('".$fetch_query[0]."','$date','$title','$detaile','$file_ext')";
...
if(isset($_POST["view"]))
{
    $query="select * from bittiexam ORDER BY `Date_time` DESC";
        ...
        $table.="<tr>"."<td align='left'>"."<a href='bitiiexam.php' class='btn btn-primary'>"."<span class='link text-center'>Back<span>"."</a>"."</td>".
        "<td colspan='6' align='center'>"."<span class='text-success' style='font-size:18px; font-weight:blod;'>Other scholarship exam</span>"."</td>"."</tr>";
        if($result){
...
if(isset($_GET["dlt"]))
{
    $Delete="DELETE FROM `bittiexam` WHERE `bittiexam_id`='".$_GET["dlt"]."'";
    $db->delete_query($Delete);
    print "<script>location='bitiiexam.php'</script>";
   $fetch_query[0]=$db->withoutPrefix('bittiexam','bittiexam_id',"14".$prefix,'12');
...
if(isset($_GET["edit"]))
{
        $select_query="SELECT * FROM `bittiexam` WHERE `bittiexam_id`='".$_GET["edit"]."'";
    ...
    {   
        ...
        $expensions= array("jpeg","jpg","png","pdf","");         
                ...
                @$inserquery="REPLACE INTO  `bittiexam`(`bittiexam_id`,`date_time`,`xm_title`,`description`,`extension`) VALUES('".$_POST["id"]."','$date','$title','$detaile','$file_ext')";
...
<link rel="stylesheet" href="../css/loading/loading.css" />
 ...
 function checkforText()
    ...
    <?php if(isset($_POST["view"]))
    {
        if(!$result)
        {
            echo "<span class='text-danger' style='font-size:22px;'>"."<strong>"."No Recorde  Found"."<a href='bitiiexam.php'>"."Go Back"."</a>"."<strong>"."</span>";
        }
        else
        {
        echo $table;

  ...
  <body>
    <form name="" action="#" method="post"  enctype="multipart/form-data" class="form-horizontal addData dataFrom">
      <div class="has-feedback col-xs-12 col-sm-8 col-lg-10 col-md-10  col-md-offset-1" id="frstPage">
        ...
        <tr>
  				<td bgcolor="#f4f4f4"  class="warning" colspan="3" bgcolor="#dddddd" align="center"><span style="font-size:22px; color:#333; display:block;">Teacher Government Salary Setup</span> </td>
  			</tr>
...
function ForUpdate(id)
{
 ...
 $.post("ajaxForGoverment.php", { Mid: Mid,update:update,amount:amount },
            function(result){
...
function Fordelete(id)
{
 ...
 $.post("ajaxForGoverment.php", { Mid: Mid,deleteS:deleteS },
            function(result){

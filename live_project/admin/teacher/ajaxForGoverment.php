...
if (isset($_POST["AddandDelete"]))
 {
	...
	$sql="INSERT INTO goverment_salary (teacher_id,amount,user_id) VALUES ('$id','$amount','$UID')";
	$db->insert_query($sql);
	if ($db->sms) {
		echo $db->sms;
	}
...
if (isset($_POST["update"]))
 {
	...
	$sql="UPDATE  goverment_salary  SET amount='$amount',user_id='$UID' where id='$id'";
	$db->update_query($sql);
	if ($db->sms) {
		echo $db->sms;
	}
...
if (isset($_POST["deleteS"]))
 {
	...
	$sql="DELETE FROM goverment_salary  where id='$id'";
	$db->delete_query($sql);
	if ($db->sms) {
		echo $db->sms;
	}
...
<tr>
	...
	<?php
	$sqls="select teachers_information.teachers_name,teachers_information.designation,goverment_salary.* from goverment_salary inner join teachers_information on goverment_salary.teacher_id=teachers_information.teachers_id";

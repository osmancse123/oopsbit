<?php
    ...
    global $chek_query;
	 $prefix=date("y"."m"."d");
$fetch_query[0]=$db->withoutPrefix('academic_calender','ID',"9".$prefix,'10');
    ...
    {   
        ...
        $expensions= array("jpeg","jpg","png","pdf","");         
                ...
                @$inserquery="INSERT INTO `academic_calender`(`ID`,`Title`,`Description`,`Extension`) VALUES('".$fetch_query[0]."','$title','$detaile','$file_ext')";
...
if(isset($_POST["view"]))
{
    $query="select * from academic_calender ORDER BY `ID` DESC";
        ...
        $table.="<tr>"."<td align='left'>"."<a href='Academic_calander.php' class='btn btn-primary'>"."<span class='link text-center'>Back<span>"."</a>"."</td>".
        "<td colspan='4' align='center'>"."<span class='text-success' style='font-size:18px; font-weight:blod;'>Academic Calendar</span>"."</td>"."</tr>";
        if($result){
...
if(isset($_GET["dlt"]))
{
    $Delete="DELETE FROM `academic_calender` WHERE `ID`='".$_GET["dlt"]."'";
    $db->delete_query($Delete);
    print "<script>location='Academic_calander.php'</script>";
    $fetch_query[0]=$db->withoutPrefix('academic_calender','ID',"9".$prefix,'10');
...
if(isset($_GET["edit"]))
{
        $select_query="SELECT * FROM `academic_calender` WHERE `ID`='".$_GET["edit"]."'";
    ...
    {   
        ...
        $expensions= array("jpeg","jpg","png","pdf","");         
                ...
                @$inserquery="REPLACE INTO `academic_calender`(`ID`,`Title`,`Description`,`Extension`) VALUES('".$_POST["id"]."','$title','$detaile','$file_ext')";
...
<link rel="stylesheet" href="../css/loading/loading.css" />
 ...
 $(document).ready(
    ...
    <?php if(isset($_POST["view"]))
    {
        if(!$result)
        {
            echo "<span class='text-danger' style='font-size:22px;'>"."<strong>"."No Academic Calender  Found"."<a href='Academic_calander.php'>"."Go Back"."</a>"."<strong>"."</span>";
        }
        else
        {
        echo $table;
...
Details &nbsp;</td>
        <td>:</td>
         <td>
            <div class="col-sm-12 col-md-12">
           <textarea  name="descreption" class="form-control" disabled="disabled"  id="redactor"><?php if($chek_query){echo $fetch_query[2]; } else { echo ""; }?> </textarea>
            </div>
            </td>

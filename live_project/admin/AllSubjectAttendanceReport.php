...
function ShowData(){
				...
				$.ajax({
							url:"ajaxForAllSubjectWiseAttendanceReport.php",
							type:"POST",
	...
	@media print{
	 ...
	 <div class="col-lg-12">
				 ...
				 <table width="1075" id="noneBtnForprin"  class="table table-bordered table-responsive" style="margin-top:10px; margin-bottom:0px">
						  <tr>
							<td colspan="5" align="center">&nbsp;<span class="text-success" style="font-size:18px;"><strong>All Subject's Attendance Report</strong></span></td>
						  </tr>
						  <tr>
						  		<td>Select Class</td>
								<td colspan="2">
						...
						<tr align="right">
						 <td colspan="5"><div class="col-md-8">
							<span>Student ID</span>	&nbsp;&nbsp;<input type="text" autocomplete="off" name="stdId"  id="stdId" placeholder='Student ID' style="width:178px;"/>

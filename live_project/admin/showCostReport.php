<?php
    ...
    require_once("../db_connect/conect.php");
	 $db = new database();
			...
			$dailyAmmount = "SELECT * FROM `other_cost` WHERE `date`='".$_POST["date"]."'";
	 ...
	 <?php
	 		...
	 		if(isset($_POST["monthlyreport"])){
					$sqlmonthlyreport = "SELECT * FROM `other_cost` WHERE `date` BETWEEN '".$_POST["frsdate"]."' AND '".$_POST["snddate"]."'";
	 ...
	 <?php
	 		if(isset($_POST["showEarlypost"])){
					...
					$yearlyshowcost = "SELECT * FROM `other_cost` WHERE  RIGHT(`date`,4) ='".$_POST["years"]."'";

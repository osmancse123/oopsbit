...
function check_all( parent_chk_bx_id, all_chk_bx_clss)
	...
	$('#struffID').keyup(function(){
		...
		if(struffID != ""){
			$.ajax({
				url : "autoComSTd.php",
				data : {forStuff:forStuff,struffID:struffID},
				type : "POST",
...
if(lent > 9){
		//alert("anik");
		 $.ajax({
                    ...
                    type: "POST",
                    url: "ajaxForStruffPaybaleSetup.php",
  ...
  *border-bottom-width: 2px;
  ...
  <form name="" action="#" method="post"  enctype="multipart/form-data" class="form-horizontal dataFrom">
  	...
  	<table align="center" class="table table-responsive box" style="border:1px #CCCCCC  solid; margin-top:30px; color: #000;">
        ...
        <tr>
  				<td bgcolor="#f4f4f4" class="warning" colspan="8"  bgcolor="#dddddd" align="center" ><span style="font-size:22px; color:#333; display:block;">Struff Payable Setting</span> </td>
  			</tr>

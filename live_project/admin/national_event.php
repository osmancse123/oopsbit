<?php
    ...
    global $msg;
	 $prefix=date("y"."m"."d");
		$fetch_query[0]=$db->withoutPrefix('national_event','Event_id',"25".$prefix,'12');
...
/*   	$select="SELECT * FROM `girlsguride`";
    ...
    {   
        ...
        $expensions= array("jpeg","jpg","png","pdf","");         
                ...
                @$inserquery="INSERT INTO `national_event`(`Event_id`,`Date_time`,`Title`,`Description`) VALUES('".$fetch_query[0]."','$date','$title','$detaile')";
  ...
  if(isset($_POST["View"]))
{
    ...
    $query="select * from national_event ORDER BY `Date_time` DESC";
        ...
        $table.="<tr>"."<td align='left'>"."<a href='national_event.php' class='btn btn-primary'>"."<span class='link text-center'>Back<span>"."</a>"."</td>".
        "<td colspan='6' align='center'>"."<span class='text-success' style='font-size:18px; font-weight:blod;'>National Event Services</span>"."</td>"."</tr>";
        if($result){
      ...
      if(isset($_GET["dlt"]))
{
    $Delete="DELETE FROM `national_event` WHERE `Event_id`='".$_GET["dlt"]."'";
    $db->delete_query($Delete);
    print "<script>location='national_event.php'</script>";
    $fetch_query[0]=$db->withoutPrefix('national_event','Event_id',"25".$prefix,'12');
...
if(isset($_GET["edit"]))
{
        $select_query="SELECT * FROM `national_event` WHERE `Event_id`='".$_GET["edit"]."'";
    ...
    {   
        ...
        $expensions= array("jpeg","jpg","png","pdf","");         
                ...
                @$inserquery="Replace INTO `national_event`(`Event_id`,`Date_time`,`Title`,`Description`) VALUES('".$_POST["id"]."','$date','$title','$detaile')";
  ...
  if(isset($_POST["View"]))
    {
        if(!$result)
        {
            echo "<span class='text-danger' style='font-size:22px;'>"."<strong>"."No Record  Found"."<a href='national_event.php'>"."Go Back"."</a>"."<strong>"."</span>";
        }
        else
        {
        echo $table;

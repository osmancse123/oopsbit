...
<table width="1200" height="221" border="0" cellpadding="0" cellspacing="0" style="margin-left:5px;margin-top:5px;  ">
  <tr>
    ...
    <td height="21" colspan="15" align="center" style="border-top:1px #000 solid; "><strong>Exam Type </strong></td>
   <td colspan="6" rowspan="2"   align="center" style="border-top:1px #000 solid; "><strong>Combined Result</strong></td>
  </tr>
  
  <tr>
    <td height="20" colspan="5" align="center"><strong>1st Tutorial Exam</strong></td>
    <td colspan="5" align="center"><strong>2nd Tutorial Exam</strong></td>
    <td colspan="5" align="center"><strong>Half Yearly Exam.</strong></td>
  </tr>
  <tr>
  ...
  <td width="69" align="center"> 1st &amp; 2nd  (30)  </td>
...
else
{
  ...
  <td width="69" align="center"><?php  $totrialAvg=$totalMarksTotrial/2;
    print $totrialAvg; ?></td>
     ...
     <?php
      ...
      {?>
         <td width="34" align="center" rowspan="<?php print $rowcount+2; ?>">
            ...
            <?php 
       $selectcgpa="SELECT * FROM `combinedresult` WHERE `Student_ID`='$fetch_r[STD_ID]'";

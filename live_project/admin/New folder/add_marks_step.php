...
function ShowBack(){
 ...
 function calculate(getid) {
        ...
        if(creat_grade==4)
        {
            ...
            else if(obtainMark > parseFloat(FullMarks * 0.33) && obtainMark <= parseFloat(FullMarks * .3999))
            {
 ...
 function calculaten(getid) {
     ...
     //alert(className);
        ...
        /////////////////// Academy /////////////////////
            // if(classIDName=="311609100003andSix" || classIDName=="311609110004andSeven" && Creative_mark < parseInt(creative * .40))
            // {
            //       grade_letter ="F";
            // document.getElementById('obtainmark-'+getid).style.background="RED";
            // document.getElementById('lettergrade-'+getid).style.background="RED";
...
//////////////////////////////////////////////
		...
		document.getElementById('CreaTiveMark-'+getid).style.borderColor ='green';
          ...
          if(obtainMark > parseFloat(FullMarks * .33) && obtainMark <= parseInt(FullMarks * 1))
          {
...
//////////////////// Academy School//////////////////////
                if(className=="311609100003andSix" || className=="311609110004andSeven")
                {
                        grade_letter="F";
                document.getElementById('obtainmark-'+getid).style.background="RED";
                document.getElementById('lettergrade-'+getid).style.background="RED";

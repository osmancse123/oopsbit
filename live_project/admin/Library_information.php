   ...
   global $checked_query;
    ...
    if(isset($_POST['add']))
    {
      ...
      $about_school=$db->escape($_POST['Contact_Textarea']);
    	...
    	{
    	$insert="INSERT INTO `library_information` VALUES('1','$title','$about_school')";
  ...
  if(isset($_POST['Update']))
    {
      ...
      {
        $insert="REPLACE INTO `library_information` VALUES('1','$title','$about_school')";
...
if(isset($_POST['Delete'])){
	$Delete="DELETE FROM `library_information` WHERE `id`='1'";
	$db->delete_query($Delete);

  print "<script>location='Library_information.php'</script>";
}
 if(isset($_POST['Exit']))
    {
        print exit;
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <div class="col-sm-10 col-md-10 col-sm-offset-1">
  	<table align="center" class="table table-responsive " style="border:1px #CCCCCC solid; margin-top:30px; color: #000;">
  			<tr>
  				<td   style="background:#113E14" colspan="3" align="center"><span style="font-size:22px; color:#FFFFFF; display:block;">
liberary Information</span> </td>
  			</tr>
      <tr class="info">

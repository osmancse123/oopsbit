...
<html lang="en">
  <head>
    ...
    <title>Fee Collection Report(Class wise)</title>
  ...
  <body>
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" >
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                <span class="glyphicon glyphicon-arrow-right text-justify text-uppercase text-warning" style="font-weight: bold; padding-top: 15px; font-size: 18px;"><strong style="padding-left:5px; text-transform: capitalize;">Fee Collection Report(Class wise)</strong></span><br/>
            ...
            function showReport(){
                    ...
                    if(type=='10'){
                        ...
                        if(type==='5'){
                              ...
                              $('#date').append('<td><strong><span class="text-success" style="font-size: 15px;">Select Date</span></strong></td><td ><div class="col-md-8"><input type="text" name="date" id="example1"  style="width:280px; border-radius:0px;" class="form-control" placeholder="dd-mm-yyyy" /></div></td>');
                        }
                        else if(type==='2'){
			       ...
			       var type =  $('#Type').val();
					...
					var forDaily  = "ASDFADSFASDF";
							...
							$.ajax({
										...
										data : {today:today,forDaily:forDaily,className:className},
										type : "POST",

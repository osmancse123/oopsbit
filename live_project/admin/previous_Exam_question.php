<?php
    ...
    global $chek_query;
     $prefix=date("y"."m"."d");
    $fetch_query[0]=$db->withoutPrefix('exam_nomuna','xmnomuna_id',"24".$prefix,'12');
    ...
    {   
        ...
        $expensions= array("jpeg","jpg","png","pdf","");         
                ...
                @$inserquery="INSERT INTO `exam_nomuna`(`xmnomuna_id`,`date_time`,`xm_title`,`description`,`extension`) VALUES('".$fetch_query[0]."','$date','$title','$detaile','$file_ext')";
...
if(isset($_POST["view"]))
{
    $query="select * from exam_nomuna ORDER BY `date_time` DESC";
        ...
        $table.="<tr>"."<td align='left'>"."<a href='previous_Exam_question.php' class='btn btn-primary'>"."<span class='link text-center'>Back<span>"."</a>"."</td>".
        "<td colspan='6' align='center'>"."<span class='text-success' style='font-size:18px; font-weight:blod;'>Test samples / Q last year</span>"."</td>"."</tr>";
        if($result){
...
if(isset($_GET["dlt"]))
{
    $Delete="DELETE FROM `exam_nomuna` WHERE `xmnomuna_id`='".$_GET["dlt"]."'";
    $db->delete_query($Delete);
    print "<script>location='previous_Exam_question.php'</script>";
    $fetch_query[0]=$db->withoutPrefix('exam_nomuna','xmnomuna_id',"24".$prefix,'12');
...
if(isset($_GET["edit"]))
{
        $select_query="SELECT * FROM `exam_nomuna` WHERE `xmnomuna_id`='".$_GET["edit"]."'";
...
if(isset($_POST["Update"]))
    {   
        ...
        $expensions= array("jpeg","jpg","png","pdf","");         
                ...
                @$inserquery="REPLACE INTO `exam_nomuna`(`xmnomuna_id`,`date_time`,`xm_title`,`description`,`extension`) VALUES('".$_POST["id"]."','$date','$title','$detaile','$file_ext')";
...
<html lang="en">
 ...
 function checkforText()
    ...
    <?php if(isset($_POST["view"]))
    {
        if(!$result)
        {
            echo "<span class='text-danger' style='font-size:22px;'>"."<strong>"."No Record  Found"."<a href='previous_Exam_question.php'>"."Go Back"."</a>"."<strong>"."</span>";
        }
        else
        {
        echo $table;
    ...
    {?>
        <div class="has-feedback col-xs-12 col-sm-8 col-lg-8 col-md-8 col-sm-offset-2 col-md-offset-2">
            <table align="center" class="table table-responsive box" style="border:1px #CCCCCC solid; margin-top:30px; color: #000;">
                            <tr>
                <td  class="warning" colspan="3" align="center"><span style="font-size:22px; color:#333; display:block;">Test samples / Q last year</span> </td>
            </tr>
         <tr class="info">

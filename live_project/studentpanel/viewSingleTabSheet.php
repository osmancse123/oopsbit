											...
											<tr align="">
												...
												<?php
													if($fetchForall["SubjectPartID"]=="NULL"){
															...
															$selectForpart="SELECT * FROM `add_subject_part_info` WHERE `part_id`='".$fetchForall["SubjectPartID"]."'";
												...
												<?php 
														...
														$selecBysub="SELECT * FROM `subject_information` WHERE `subjectId`='".$fetchForall["SubjectId"]."'";
														$resulBysub=$db->select_query($selecBysub);
															...
															$selecBYpart="SELECT * FROM `subject_information` WHERE `subPartId`='".$fetchForall["SubjectPartID"]."'";

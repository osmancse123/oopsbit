<?php
  ...
  if (isset($_POST["addbtn"])) 
  {
    if (!empty($detail)) 
      {
            $insert="REPLACE INTO `contuct_us` (`id`,`detail`) VALUES ('1','$detail')";
            $ob->insert($insert);
      }
  }

      $sql="SELECT * FROM `contuct_us` WHERE `id`='1'";
...
<html lang="en">
  ...
  <body>
    ...
    <table class="table" style="width:80%;margin-top: 50px;" align="center">
      ...
      <thead>
        <tr>
          <th style="background-color:#2962FF; color: #fff;"><h2><center>CONTUCT US</center></h2></th>
        </tr>
      </thead>
